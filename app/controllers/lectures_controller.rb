class LecturesController < ApplicationController
  ...
  private
    ...
    def lecture_params
      params.require(:lecture).permit(:title, :description, :category_id, :picture, :teacher_id, :video, :enrollment_id, :learning_outcomes, :long_description, :teacher_description, :background_image, :permalink, :approved, :learn_description, :practice_description, :hired_description)
    end
