class LecturesController < ApplicationController
  ...
  private
    ...
    def lecture_params
      params.require(:lecture).permit(:title, :description, :category_id, :picture, :teacher_id, :video, :enrollment_id, :permalink, :approved, :learn_description, :practice_description, :hired_description)
    end
